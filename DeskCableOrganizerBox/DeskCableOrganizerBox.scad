...
// cut out holes for cables
    translate([1*(14 + 4), 0, BOX_H])
rotate([90,0,0])
...
module lid() {
    ...
    intersection() {
        ...
        hexgrid(size=[BOX_W * 1.5, BOX_L * 1.5, CORNER_RADIUS*2],cell_hole=20,cell_wall=4);
    }
}
